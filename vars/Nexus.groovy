    ...
    node
        {
            ...
            stage('Publish') 
                { 
                 sh "dotnet nuget push /var/lib/jenkins/workspace/Back_main/source/DevOpsProject/bin/Debug/bin/Debug/aosora.1.0.0.nupkg -s http://87.106.205.95:4002/repository/nuget-hosted/ -k 5f15c27d-1f8a-3baa-a136-cd624ba7c9b7 "
