           ...
           stage("GitSCM") {
            ...
            stage('Quality Gate') 
                {  
                    ...
                    sh "${scannerHome}/bin/sonar-scanner begin sonar.projectKey=Aoso sonar.sources=. sonar.host.url=http://192.168.56.113:9000 sonar.login=ab9f339761ec69b84c33072c739b28b604d3f8ce "
