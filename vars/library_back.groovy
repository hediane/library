           ...
           stage("testCheckout") {
            ...
            stage('SonarQube Analysis') 
                {  
                    ...
                    sh "${scannerHome}/bin/sonar-scanner begin -Dsonar.projectKey=Aoso -Dsonar.sources=. -Dsonar.host.url=http://192.168.56.113:9000 -Dsonar.login=ab9f339761ec69b84c33072c739b28b604d3f8ce"
