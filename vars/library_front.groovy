        ...
        { 
         ...
         stage('Quality Gate') 
                {   scannerHome = tool name: 'sonarscanner';
                    ...
                    sh "${scannerHome}/bin/sonar-scanner -Dsonar.projectKey=Aosofront -Dsonar.sources=. -Dsonar.login=29fe91d338d972127f00d40ba7b9dabcd01363da -Dsonar.scm.provider=git "
