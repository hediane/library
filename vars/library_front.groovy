        ...
        { 
         ...
         stage('Quality Gate') 
                {   scannerHome = tool name: 'sonarscanner';
                    ...
                    sh "${scannerHome}/bin/sonar-scanner -Dsonar.projectKey=Aosofront -Dsonar.sources=. -Dsonar.host.url=http://192.168.56.113:9000 -Dsonar.login=29fe91d338d972127f00d40ba7b9dabcd01363da -Dsonar.scm.provider=git "
